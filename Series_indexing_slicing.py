...
print(list_s['e':'g'])  # Slicing from index 'e' to 'g'   ----> how value at index 'g' is printed it violates the rule of slicing
print(list_s['a':'g':-1])    # why it displayed empty list
